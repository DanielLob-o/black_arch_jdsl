...
```sh
omarchy-theme-install https://github.com/DanielLob-o/omarchy-black-poison-theme.git
```
...
```sh
git clone https://github.com/DanielLob-o/omarchy-black-poison-theme.git
cd omarchy-black-poison-theme
```
